...
/* ==========================================================
   023 - Stock clasificado por stage ingreso/salida y fixes UI
   - B1.ST.% se muestra como cantidad_en_picking, no disponible.
   - B1.RE.% se muestra como cantidad_en_ingreso, no disponible.
   - Stock general agrega cantidad_en_ingreso.
   ========================================================== */

IF OBJECT_ID('dbo.stock_ubicacion', 'U') IS NULL
    THROW 52301, 'No existe dbo.stock_ubicacion.', 1;
IF OBJECT_ID('dbo.ubicaciones', 'U') IS NULL
    THROW 52302, 'No existe dbo.ubicaciones.', 1;
IF OBJECT_ID('dbo.productos', 'U') IS NULL
    THROW 52303, 'No existe dbo.productos.', 1;
IF OBJECT_ID('dbo.unidades_medida', 'U') IS NULL
    THROW 52304, 'No existe dbo.unidades_medida.', 1;
...
SELECT 'OK - vistas de stock actualizadas con cantidad_en_ingreso y stage salida como picking' AS resultado;
